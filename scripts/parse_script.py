...
class CharacterManager:
    ...
    def add_quote(self, c: str, q: str):
        ...
        quote = self.quote_builder(c, q, character_index, self.quotes_count)
    ...
    def serialize(self):
        ...
        quotes = [SerializeQuote.from_quote(q) for q in quotes]
...
if __name__ == "__main__":
    print("Nothing happened or will happen! Please run parsing_scripts.py instead!")
